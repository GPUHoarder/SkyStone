...
//@Disabled
public class Correction extends LinearOpMode
{
    ...
    public void correct() {
        ...
        trobot.getLeftDriveFront().setPower(-correction);
        trobot.getLeftDriveBack().setPower(-correction);
        trobot.getRightDriveFront().setPower(correction);
        trobot.getRightDriveBack().setPower(correction);
    }
