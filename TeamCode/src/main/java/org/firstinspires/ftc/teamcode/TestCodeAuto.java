...
public class TestCodeAuto extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive() && runtime.seconds() <= 4.3) {
            ...
            telemetry.addData("1 correction", correction);
            telemetry.update();
        ...
        runtime.reset();
        while (opModeIsActive() && runtime.seconds() <= 1.95) {
            // Use gyro to drive in a straight line.
            correction = checkDirection();

            telemetry.addData("2 imu heading", lastAngles.firstAngle);
        ...
        while (opModeIsActive() && runtime.seconds() <= 0.5) {
            ...
            telemetry.addData("3 imu heading", lastAngles.firstAngle);
            telemetry.addData("3 global heading", globalAngle);
        ...
        while (opModeIsActive() && runtime.seconds() <= 2.65) {
            ...
            telemetry.addData("4 imu heading", lastAngles.firstAngle);
            telemetry.addData("4 global heading", globalAngle);
